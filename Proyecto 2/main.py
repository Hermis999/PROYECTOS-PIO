peliculas = [
    ...
    "descripcion":"dedpul busca a guolberin y matan gente", 
    "genero":["drama","secuela","triller"],
    "clasificacion":"exclusiva para mayores de 15 años",
    "duracion":"138",
    "director":["todd phillips"],
    "actores":["joaquin phoenix","lady gaga", "beyonce"]}
]
...
def mostrar_todas_peliculas(peliculas):
    ...
    for pelicula in peliculas:
        ...
        print(f"Descripcion: {pelicula["descripcion"]}")
